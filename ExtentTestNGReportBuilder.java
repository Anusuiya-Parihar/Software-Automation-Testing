...
public class ExtentTestNGReportBuilder {
 ...
 static {
  ...
  Date date = new Date();
  dir = new File(System.getProperty("C:\\Users\\paria\\Downloads\\Report\\Report") + dateFormat.format(date));
 ...
 public void beforeSuite() {
  ...
  // System.out.println("extentReportFileextentReportFile" + extentReportFile);
	 String reportPath=classs.createNewDirectory(".\\ExtentReport\\Reports_");
 ...
 public synchronized void afterMethod(ITestResult result) {
  if (result.getStatus() == ITestResult.FAILURE) {
   try {
    screenshotPath = classs.captureScreenshot(result.getName());
